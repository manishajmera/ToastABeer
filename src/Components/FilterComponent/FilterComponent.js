...
export default function FilterComponent({foodFilterList,setFoodFilterList,handleIngredientFilter}) {
    ...
    return (
       <div className="row filter">
            <div className="col col-sm-7 filter-by-ingredient">
                ...
                <input type="text" id="ingredientName" className="form-control filter-by-ingredient" placeholder="Enter ingrident name"/>
                <input type="number" id="ingredientValue" className="form-control filter-by-ingredient" min="0" max="50" step="0.1" placeholder="Ranges from 0 to selected value"/>
